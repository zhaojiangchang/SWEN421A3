...
package body Pump_Unit_Setup_Task is
   ...
   begin
      print("Initialize PUMP_UNIT 1");
      PUMP_UNIT.initial(PUMP_UNIT_OBJECTS.PUMP_UNIT_1);
      print("Initialize PUMP_UNIT 2");
      ...
      UNIT_1.IS_PUMP_UNIT_SETUP:=True;
      UNIT_2.IS_PUMP_UNIT_SETUP:=True;
      UNIT_1.STATE:=PUMP_UNIT.Inoperative;
      UNIT_2.STATE:=PUMP_UNIT.Inoperative;
