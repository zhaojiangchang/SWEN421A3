...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cash_register_harness" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9e2eb28d#;
   pragma Export (C, u00001, "cash_register_harnessB");
   ...
   u00163 : constant Version_32 := 16#d283eae0#;
   pragma Export (C, u00163, "cash_register_suiteB");
   u00164 : constant Version_32 := 16#d6509ad2#;
   pragma Export (C, u00164, "cash_register_suiteS");
   u00165 : constant Version_32 := 16#1fe9e26d#;
   pragma Export (C, u00165, "cash_registerB");
   u00166 : constant Version_32 := 16#d5b1197e#;
   pragma Export (C, u00166, "cash_registerS");
   u00167 : constant Version_32 := 16#7aca4c27#;
   pragma Export (C, u00167, "sprintB");
   u00168 : constant Version_32 := 16#d602009f#;
   pragma Export (C, u00168, "sprintS");
   ...
   u00178 : constant Version_32 := 16#e387b57e#;
   pragma Export (C, u00178, "pumpB");
   u00179 : constant Version_32 := 16#e5f7b109#;
   pragma Export (C, u00179, "pumpS");
   ...
   u00190 : constant Version_32 := 16#f14c45ed#;
   pragma Export (C, u00190, "pump_unitB");
   u00191 : constant Version_32 := 16#e2e2fa93#;
   pragma Export (C, u00191, "pump_unitS");
   u00192 : constant Version_32 := 16#7b592af1#;
   pragma Export (C, u00192, "cash_register__testB");
   u00193 : constant Version_32 := 16#ec8961ef#;
   pragma Export (C, u00193, "cash_register__testS");
   u00194 : constant Version_32 := 16#f9b5bb0c#;
   pragma Export (C, u00194, "aunit__test_casesB");
   u00195 : constant Version_32 := 16#b9f05298#;
   pragma Export (C, u00195, "aunit__test_casesS");
   u00196 : constant Version_32 := 16#6a86c9a5#;
   pragma Export (C, u00196, "system__storage_pools__subpoolsB");
   u00197 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00197, "system__storage_pools__subpoolsS");
   u00198 : constant Version_32 := 16#9aad1ff1#;
   ...
   --  aunit.run%s
   --  aunit.run%b
   --  cash_register_suite%s
   --  cash_register_harness%b
   --  pump%s
   --  pump_unit%s
   --  cash_register%s
   --  cash_register.test%s
   --  cash_register_suite%b
   --  sprint%s
   --  sprint%b
   --  cash_register.test%b
   --  cash_register%b
   --  pump_unit%b
   --  pump%b
